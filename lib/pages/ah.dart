...
class CardLayout6 extends StatefulWidget {
  const CardLayout6({Key? key}) : super(key: key);

  @override
  _CardLayout6State createState() => _CardLayout6State();
}
...
class _CardLayout6State extends State<CardLayout6> {
  @override
